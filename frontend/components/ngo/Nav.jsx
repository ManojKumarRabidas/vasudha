    ...
    <nav className="sticky top-0 bg-white border-b border-gray-100 shadow-sm z-40">
      <div className="max-w-7xl mx-auto px-4 py-4 flex justify-between items-center">
        ...
        <div className="hidden md:flex items-center gap-8">
          ...
          <a href="#" className="text-gray-600 hover:text-primary transition">Volunteers</a>
          <a href="#" className="text-gray-600 hover:text-primary transition">Activities</a>
        </div>
      ...
      {mobileMenuOpen && (
        <div className="md:hidden border-t border-gray-100 bg-white">
          <div className="px-4 py-4 space-y-4">
            ...
            <a href="#" className="block text-gray-600 hover:text-primary">Volunteers</a>
            <a href="#" className="block text-gray-600 hover:text-primary">Activities</a>
