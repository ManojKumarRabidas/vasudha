        ...
        <div className="w-full max-w-md">
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 mb-8">
            ...
            <form onSubmit={handleLogin} className="space-y-5">
              ...
              {/* Login Button */}
              <button type="submit" disabled={loading} className="w-full py-2.5 bg-primary text-white rounded-lg font-semibold hover:bg-primary-dark transition disabled:opacity-70 flex items-center justify-center gap-2">
                {loading && <Loader className="w-4 h-4 animate-spin" />} Sign In
              </button>
              <span className='my-2 mx-auto flex items-center'>Don't have an account? &nbsp;<a href="/auth/register" className="text-primary font-semibold hover:text-primary-dark transition"> Sign up</a></span>
            </form>
          </div>
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8">
            ...
            <div className="space-y-3">
              {demoAccounts.map((account, i) => (
                <button key={i} onClick={() => handleDemoLogin(account)}
